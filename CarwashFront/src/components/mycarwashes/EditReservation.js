...
import LockOutlinedIcon from '@material-ui/icons/EditAttributes';
...
export default function EditReservationF() {
    ...
    async function editReservation(credentials) {
        return fetch(`https://localhost:7090/api/booking/${parseInt(bookingId)}`, {
            mode: "cors",
            method: "PUT",
            headers: {
    ...
    const handleSubmit = async (e) => {
        ...
        if (statusCodeCustom === 200) {
            swal("Success", "Carwash edited successfully !", "success", {
                buttons: false,
                timer: 2000,
            })
                .then((value) => {
            ...
            <Grid item xs={12} md={5} component={Paper} elevation={6} square>
                <div className={classes.paper}>
                    ...
                    <Typography component="h1" variant="h5">
                        Confirm/Reject pending reservation
                    </Typography>
